...
function SignUp() {
  ...
  return (
    <div className="fixed h-screen w-full bg-lime-50">
      ...
      <form
        className="absolute bg-opacity-30 backdrop-filter backdrop-blur-lg h-3/4 w-auto p-6 bg-violet-400 top-[10%] left-[32%] rounded-lg grid grid-flow-row gap-0 items-center"
